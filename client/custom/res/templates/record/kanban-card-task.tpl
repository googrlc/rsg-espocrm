<div class="panel panel-default kanban-card task-kanban-card {{cardClass}} {{assigneeClass}}" data-id="{{id}}" data-state="closed">
    <div class="panel-body">
        <div class="task-card__header">
            ...
            <h4 class="task-card__title">
                <a href="#Task/view/{{id}}" class="task-card__title-link" data-action="openTask">{{name}}</a>
            </h4>
            <span class="task-card__assignee-badge" title="Assigned to {{assignedUserName}}">{{assigneeInitials}}</span>
        </div>
